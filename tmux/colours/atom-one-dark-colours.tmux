...
set -g status-right "#[fg=#3b4048,bg=#2c323c,nobold,nounderscore,noitalics]#[fg=#abb2bf,bg=#3b4048] %A %d %B %Y  %H:%M #[fg=#98c379,bg=#3b4048,nobold,nounderscore,noitalics]#[fg=#2c323c,bg=#98c379] #h "
